...
function perlin:noise( x, y, z )
    ...
    return utils.lerp(
      w, utils.lerp(
        v, utils.lerp(
          u, grad(self.p[AA+1], x  , y  , z  ),
                                   grad(self.p[BA+1], x-1, y  , z  )),
                           utils.lerp(u, grad(self.p[AB+1], x  , y-1, z  ),
                                   grad(self.p[BB+1], x-1, y-1, z  ))),
                   utils.lerp(v, utils.lerp(u, grad(self.p[AB+2], x  , y  , z-1),
                                   grad(self.p[BA+2], x-1, y  , z-1)),
                           utils.lerp(u, grad(self.p[AB+2], x  , y-1, z-1),
